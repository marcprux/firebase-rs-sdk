...
fn array_contains(array: &crate::value::ArrayValue, needle: &FirestoreValue) -> bool {
    array.values().iter().any(|candidate| candidate == needle)
}

fn array_contains_any(array: &crate::value::ArrayValue, needles: &crate::value::ArrayValue) -> bool {
...
mod tests {
    use super::*;
    use crate::api::{database::Firestore, query::Query, snapshot::SnapshotMetadata};
    use crate::model::{DatabaseId, DocumentKey, FieldPath, ResourcePath};
    use crate::value::{FirestoreValue, MapValue};
    use crate::OrderDirection;
    use firebase_core::test_support::firebase::test_firebase_app_with_api_key;
