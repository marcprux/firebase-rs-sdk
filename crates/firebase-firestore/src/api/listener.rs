...
use crate::query_evaluator::compare_snapshots;
use crate::remote::listen::{
...
use crate::remote::watch_change::{TargetChangeState, WatchChange, WatchDocument};
...
mod tests {
    ...
    fn new_documents_are_reported_as_added() {
        ...
        assert_eq!(changes[0].change_type(), crate::DocumentChangeType::Added);
    ...
    fn rewritten_documents_are_reported_as_modified_with_both_indexes() {
        ...
        assert_eq!(changes.len(), 1);
        assert_eq!(changes[0].change_type(), crate::DocumentChangeType::Modified);
    ...
    fn documents_that_only_shift_position_are_not_reported() {
        ...
        assert_eq!(changes[0].change_type(), crate::DocumentChangeType::Removed);
        assert_eq!(changes[0].doc().id(), "b");
