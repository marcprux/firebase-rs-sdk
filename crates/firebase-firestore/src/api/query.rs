...
mod tests {
    ...
    use crate::Firestore;
    use crate::MapValue;
    use crate::{DatabaseId, DocumentKey, FieldPath, ResourcePath};
    use firebase_core::app::FirebaseApp;
    use firebase_core::app::FirebaseAppConfig;
...
mod filter_and_cursor_tests {
    ...
    use crate::remote::structured_query::encode_structured_query;
    use crate::value::MapValue;
    use crate::FirestoreErrorCode;
