...
impl GoogleAuthProvider {
    ...
    pub fn credential(id_token: Option<&str>, access_token: Option<&str>) -> crate::AuthCredential {
...
impl FacebookAuthProvider {
    ...
    pub fn credential(access_token: &str) -> crate::AuthCredential {
