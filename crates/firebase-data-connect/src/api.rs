...
use crate::config::{parse_transport_options, ConnectorConfig, DataConnectOptions, TransportOptions};
use crate::constants::DATA_CONNECT_COMPONENT_NAME;
use crate::error::{internal_error, DataConnectError, DataConnectErrorCode, DataConnectResult};
...
pub async fn execute_mutation(mutation_ref: &MutationRef) -> DataConnectResult<crate::reference::MutationResult> {
    mutation_ref
        .service()
        .mutation_manager()
        .await?
