...
use crate::constants::AI_COMPONENT_NAME;
use crate::error::{internal_error, invalid_argument, AiError, AiErrorCode, AiResult, CustomErrorData};
...
impl AiService {
    ...
    ///
    /// ```no_run
    /// # use firebase_ai::{AiService, GenerateTextRequest};
    /// # async fn example(ai: AiService) -> firebase_ai::AiResult<()> {
    /// let response = ai
...
///
/// ```
/// # use firebase_ai::{get_ai, AiOptions, Backend};
