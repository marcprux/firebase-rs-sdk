use crate::error::{internal_error, invalid_argument, invalid_root_operation, no_download_url, StorageResult};
use crate::list::{parse_list_result, ListOptions, ListResult};
use crate::location::Location;
use crate::metadata::serde::ObjectMetadata;
use crate::path::{child, last_component, parent};
...
use crate::stream::UploadAsyncRead;
use crate::string::{prepare_string_upload, StringFormat};
use crate::upload::{UploadProgress, UploadTask};
#[cfg(all(feature = "wasm-web", target_arch = "wasm32"))]
use crate::wasm;
use crate::{SettableMetadata, UploadMetadata};
...
impl StorageReference {
    ...
    /// # Errors
    ///
    /// Returns [`StorageError`](crate::StorageError) with code
    ...
    /// # Errors
    ///
    /// Returns [`storage/invalid-root-operation`](crate::StorageErrorCode::InvalidRootOperation)
    ...
    /// # use firebase_storage::get_storage_for_app;
    ///
    ...
    /// behaviour of the Firebase Web SDK. The returned [`crate::upload::UploadTask`]
