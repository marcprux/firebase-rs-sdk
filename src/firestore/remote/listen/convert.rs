...
//! [`JsonProtoSerializer`](crate::firestore::remote::serializer::JsonProtoSerializer); the `Listen`
...
pub(crate) fn value_to_proto(value: &FirestoreValue) -> FirestoreResult<fs::Value> {
    let value_type = match value.kind() {
        ...
        ValueKind::GeoPoint(point) => {
            fs::value::ValueType::GeoPointValue(crate::firestore::remote::proto::google::r#type::LatLng {
...
/// Encodes a query the same way [`encode_structured_query`](crate::firestore::remote::structured_query)
...
mod tests {
    use super::*;
    use crate::firestore::api::query::{FilterOperator, OrderDirection, Query};
    use crate::firestore::model::{DatabaseId, FieldPath, ResourcePath};
    use crate::firestore::value::BytesValue;
    ...
    fn query_for(path: &str) -> Query {
        ...
        let container = crate::component::ComponentContainer::new("listen-convert-test");
        let app = FirebaseApp::new(options, config, container);
        let firestore = crate::firestore::Firestore::new(app, DatabaseId::new("demo-project", "(default)"));
    ...
    fn composite_filters_are_encoded_as_nested_filters() {
        let field = |name: &str| FieldPath::from_dot_separated(name).expect("field");
        let query = query_for("rooms")
            .where_filter(crate::firestore::api::query::or(vec![
                crate::firestore::api::query::where_filter(
                    field("seats"),
